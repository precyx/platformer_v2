...
Game.Load = {
  ...
  images: function(names, path, filetype, callback) { // load multiple images and callback when ALL images have loaded
    ...
    for(n = 0 ; n < names.length ; n++) {
      ...
      result[name].src = path+name+filetype;
    }
...
Game.Math = {
  ...
  randomSteppedInt: function(min, max, step) { var val = Math.round(this.random(min, max)); return val - val%step; },
